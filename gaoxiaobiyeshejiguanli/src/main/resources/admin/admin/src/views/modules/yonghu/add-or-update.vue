    ...
    <div class="addEdit-block">
        <el-form
            ...
            <el-row>
               ...
               <el-col :span="12">
                   <el-form-item class="input" v-if="type!='info'"  label="学号" prop="username">
                       <el-input v-model="ruleForm.username"
                                 placeholder="学号" clearable  :readonly="ro.username"></el-input>
                   </el-form-item>
                   <div v-else-if="type=='info'">
                       <el-form-item class="input" label="学号" prop="username">
                           <el-input v-model="ruleForm.username"
