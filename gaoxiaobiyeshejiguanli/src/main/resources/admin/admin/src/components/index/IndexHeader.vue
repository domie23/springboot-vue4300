	...
	export default {
		data() {
			return {
				...
				ruleForm: {},
				user: {},
				heads: {"headLogoutFontHoverColor":"#fff","headFontSize":"20px","headUserInfoFontColor":"#333","headBoxShadow":"0 1px 0px #444","headTitleImgHeight":"44px","headLogoutFontHoverBgColor":"rgba(150, 150, 150, 1)","headFontColor":"#000","headTitleImg":false,"headHeight":"60px","headTitleImgBorderRadius":"22px","headTitleImgUrl":"http://codegen.caihongy.cn/20201021/cc7d45d9c8164b58b18351764eba9be1.jpg","headBgColor":"linear-gradient(90deg, rgba(255,255,255,1) 0%, rgba(235,235,235,1) 12.4%, rgba(121,130,139,1) 18%, rgba(255,255,255,1) 38%, rgba(255,255,255,1) 75%, rgba(121,130,139,1) 75%, rgba(252,253,255,1) 0%, rgba(255,253,253,0.819765406162465) 100%)","headTitleImgBoxShadow":"0 1px 6px #444","headLogoutFontColor":"#333","headUserInfoFontSize":"16px","headTitleImgWidth":"44px","headTitleStyle":"1","headLogoutFontSize":"16px"},
			};
		},
		created() {
			this.setHeaderStyle()
