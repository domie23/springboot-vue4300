...
public class DabianshenqingView extends DabianshenqingEntity implements Serializable {
    private static final long serialVersionUID = 1L;

		/**
		* 答辩状态的值
		*/
		private String dabianshenqingValue;
		/**
		* 审核情况的值
		*/
		private String dabianshenqingYesnoValue;
	...
	public DabianshenqingView() {

	}

	public DabianshenqingView(DabianshenqingEntity dabianshenqingEntity) {
		try {
			BeanUtils.copyProperties(this, dabianshenqingEntity);
			...
			* 获取： 答辩状态的值
			*/
			public String getDabianshenqingValue() {
				return dabianshenqingValue;
			}
			/**
			* 设置： 答辩状态的值
			*/
			public void setDabianshenqingValue(String dabianshenqingValue) {
				this.dabianshenqingValue = dabianshenqingValue;
			}
			/**
			* 获取： 审核情况的值
			*/
			public String getDabianshenqingYesnoValue() {
				return dabianshenqingYesnoValue;
			}
			/**
			* 设置： 审核情况的值
			*/
			public void setDabianshenqingYesnoValue(String dabianshenqingYesnoValue) {
				this.dabianshenqingYesnoValue = dabianshenqingYesnoValue;
			}
