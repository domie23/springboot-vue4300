 ...
 */
@TableName("wodeketi")
public class WodeketiView extends WodeketiEntity implements Serializable {
	...
	public WodeketiView(WodeketiEntity wodeketiEntity) {
		try {
			BeanUtils.copyProperties(this, wodeketiEntity);
