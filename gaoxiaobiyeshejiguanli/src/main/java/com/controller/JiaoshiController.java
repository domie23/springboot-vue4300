                ...
                if(!".xls".equals(suffix)){
                    ...
                    if(!file.exists()){
                        ...
                        for(List<String> data:dataList){
                            //循环
                            JiaoshiEntity jiaoshiEntity = new JiaoshiEntity();
                            jiaoshiEntity.setUsername(data.get(0));                    //工号 要改的
                            //jiaoshiEntity.setPassword("123456");//密码
                            jiaoshiEntity.setJiaoshiName(data.get(1));                    //教师姓名 要改的
                            jiaoshiEntity.setJiaoshiPhoto("");//详情和图片
                            jiaoshiEntity.setSexTypes(Integer.valueOf(data.get(2)));   //性别 要改的
                            jiaoshiEntity.setJiaoshiPhone(data.get(3));                    //联系方式 要改的
                            ...
                            //把要查询是否重复的字段放入map中
                                ...
                                if(seachFields.containsKey("jiaoshiPhone")){
                                    ...
                                    jiaoshiPhone.add(data.get(3));//要改的
                                }else{
