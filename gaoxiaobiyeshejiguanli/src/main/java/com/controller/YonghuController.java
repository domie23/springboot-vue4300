                ...
                if(!".xls".equals(suffix)){
                    ...
                    if(!file.exists()){
                        ...
                        for(List<String> data:dataList){
                            //循环
                            YonghuEntity yonghuEntity = new YonghuEntity();
                            yonghuEntity.setUsername(data.get(0));                    //学号 要改的
                            ...
                            yonghuEntity.setZhuanyeTypes(Integer.valueOf(data.get(4)));   //专业 要改的
                            yonghuEntity.setBanjiTypes(Integer.valueOf(data.get(5)));   //班级 要改的
